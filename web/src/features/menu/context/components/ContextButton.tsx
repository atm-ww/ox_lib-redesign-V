...
const useStyles = createStyles((theme, params: { disabled?: boolean; readOnly?: boolean }) => ({
  ...
  label: {
    ...
    textShadow: params.disabled ? 'none' : '0 0 8px #ffffff',
    whiteSpace: 'pre-wrap',
  },
  button: {
    height: 'fit-content',
    ...
    '&:hover': {
      backgroundColor: params.readOnly ? 'transparent' : 'rgba(0, 255, 255, 0.1)',
  ...
  description: {
    color: params.disabled ? 'rgba(255, 255, 255, 0.4)' : '#ffffff',
    textShadow: params.disabled ? 'none' : '0 0 5px #ffffff',
    fontSize: 12,
  },
  dropdown: {
    padding: 10,
